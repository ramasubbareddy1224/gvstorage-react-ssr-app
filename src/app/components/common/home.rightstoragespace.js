                              ...
                              <div className="tab-content" id="myTabContent">
                                ...
                                <div className="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                  <div className="tab-content">
                                      ...
                                      <div className="col-md-5 p-5"><img src="img/5x10.png" className="img-fluid" /></div>
                                ...
                                <div className="tab-content">
                                      ...
                                      <div className="col-md-5 p-5"><img src="img/10x10.png" className="img-fluid" /></div>
                                ...
                                <div className="tab-content">
                                      ...
                                      <div className="col-md-5 p-5"><img src="img/10x15.png" className="img-fluid" /></div>
                                ...
                                <div className="tab-content">
                                      ...
                                      <div className="col-md-5 p-5"><img src="img/10x20.png" className="img-fluid" /></div>
                                ...
                                <div className="tab-content">
                                      ...
                                      <div className="col-md-5 p-5"><img src="img/10x30.png" className="img-fluid" /></div>
...
export default HomeRightStorageSpace;
