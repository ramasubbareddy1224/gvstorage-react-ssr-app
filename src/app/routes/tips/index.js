...
class Tips extends Component {
  componentDidMount(){
    let $=require('jquery');
    $('#tips-head').addClass('active');
    $('#tips-content').addClass('active');
  ...
  render() {
    return (
      <Page id="tips"
      title="Packing and Storage Tips | Great Value Storage"
      description="Helpful tips on how to best pack and store your belongings. Call one of our friendly professional staff for more information.">
    <HomeBanner pageName="Tips" allPinCodes_Sites ={this.props.allPinCodes_Sites}></HomeBanner>
    <CommonStaticBreadCrumb pageName="Tips" routeName="Storage Tools" ></CommonStaticBreadCrumb>
    <main id="main">
